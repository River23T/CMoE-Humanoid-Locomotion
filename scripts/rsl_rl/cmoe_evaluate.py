...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    if args_cli.velocity is not None:
        velocity = float(args_cli.velocity)
        for command_ranges in (
            ...
            command_ranges.lin_vel_x = (velocity, velocity)
            command_ranges.lin_vel_y = (0.0, 0.0)
            command_ranges.ang_vel_z = (0.0, 0.0)
            command_ranges.heading = (0.0, 0.0)

    lin_vel_x = env_cfg.commands.base_velocity.easy_ranges.lin_vel_x[0]
