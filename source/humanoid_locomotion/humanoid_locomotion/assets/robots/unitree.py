...
UNITREE_MODEL_DIR = "/root/gpufree-data/unitree_model"  # Replace with the actual path to your unitree_model directory
...
UNITREE_G1_29DOF_DelayPD_CFG = UnitreeArticulationCfg(
    # spawn=UnitreeUrdfFileCfg(
    #     asset_path=f"{UNITREE_ROS_DIR}/robots/g1_description/g1_29dof_rev_1_0.urdf",
    # ),
    spawn=UnitreeUsdFileCfg(
...
UNITREE_G1_23DOF_DelayPD_CFG = UnitreeArticulationCfg(
    # spawn=UnitreeUrdfFileCfg(
    #     asset_path=f"{UNITREE_ROS_DIR}/robots/g1_description/g1_23dof_rev_1_0.urdf",
    # ),
    spawn=UnitreeUsdFileCfg(
    ...
    actuators={
        ...
        "N5020-16-parallel": DelayedPDActuatorCfg(
            joint_names_expr=[".*ankle.*"],  # 4
            effort_limit=35,
            velocity_limit=30,
            stiffness=40.0,
